        ...
        <div class="content-row">
          ...
          <div class="chart-container">
            ...
            <div class="bar-chart">
              <div class="bar-group">
                <div class="bar-item">
                  <div class="bar" :style="{ height: `${ratings.provider * 20}px`, backgroundColor: '#1f6feb' }"></div>
                  <div class="label">Service Provider</div>
                </div>
                <div class="bar-item">
                  <div class="bar" :style="{ height: `${ratings.delivery * 20}px`, backgroundColor: '#f59e0b' }"></div>
                  <div class="label">Service Delivery process</div>
                </div>
                <div class="bar-item">
                  <div class="bar" :style="{ height: `${ratings.facilities * 20}px`, backgroundColor: '#ef4444' }"></div>
